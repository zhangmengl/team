...
@csrf
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="admin_name" value="{{$res->admin_name}}" placeholder="请输入管理员姓名">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
		<input type="password" class="form-control" name="admin_pwd" value="{{$res->admin_pwd}}" placeholder="请输入管理员密码">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
		<input type="text" class="form-control" name="admin_tel" value="{{$res->admin_tel}}" placeholder="请输入管理员手机号">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
        <input type="email" class="form-control" name="admin_email" value="{{$res->admin_email}}" placeholder="请输入管理员邮箱">  
  ...
  <div class="form-group">
		...
		<div class="col-sm-8">
            <input type="radio" name="admin_level" value="1" {{$res->admin_level=="1" ? "checked" : ""}}>普通管理员
            <input type="radio" name="admin_level" value="2" {{$res->admin_level=="2" ? "checked" : ""}}>产品经理
		</div>
  </div>
