...
<center><h2>业务员添加<a href="{{url('/sale/index')}}"></a></h2></center><br>
...
<form action="{{url('sale/store')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">业务员名称</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" name="sale_name" id="firstname" 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
			<input type="text" class="form-control" name="sale_phone" id="firstname" 
           placeholder="请输入办公电话...">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
			<input type="text" class="form-control" name="sale_tel" id="firstname" 
           placeholder="请输入手机号...">
